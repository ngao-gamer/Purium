local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/ngao-gamer/Purium/refs/heads/main/Purium.txt"))()
...
Button.Image = "rbxassetid://121302760641013" -- Thay icon nếu muốn
...
print("Loaded All asset and UI!")
print("if you have any issue just go to our discord to report !")
print("im white")
